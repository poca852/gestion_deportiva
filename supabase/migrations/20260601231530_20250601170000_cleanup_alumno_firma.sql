-- Limpieza: eliminar campo no usado firma_entrenador_url de alumnos

ALTER TABLE public.alumnos
  DROP COLUMN IF EXISTS firma_entrenador_url;

-- Eliminar 'firmas-alumno' de las políticas de storage (ya no existe como carpeta válida)
